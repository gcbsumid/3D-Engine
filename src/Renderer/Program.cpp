...
GLuint backlash::Program::Object() const {
    return mObject;
}

void backlash::Program::Use() const {
    glUseProgram(mObject);
}

bool backlash::Program::IsInUse() const {
...
GLuint backlash::Program::Attrib(const GLchar* attribName) const {
    if (!attribName) {
...
GLint backlash::Program::Uniform(const GLchar* uniformName) const {
    if (!uniformName) {
...
\
    void backlash::Program::SetAttrib(const GLchar* name, OGL_TYPE v0) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 1 ## TYPE_SUFFIX (Attrib(name), v0); } \
    void backlash::Program::SetAttrib(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 2 ## TYPE_SUFFIX (Attrib(name), v0, v1); } \
    void backlash::Program::SetAttrib(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1, OGL_TYPE v2) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 3 ## TYPE_SUFFIX (Attrib(name), v0, v1, v2); } \
    void backlash::Program::SetAttrib(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1, OGL_TYPE v2, OGL_TYPE v3) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 4 ## TYPE_SUFFIX (Attrib(name), v0, v1, v2, v3); } \
\
    void backlash::Program::SetAttrib1v(const GLchar* name, const OGL_TYPE* v) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 1 ## TYPE_SUFFIX ## v (Attrib(name), v); } \
    void backlash::Program::SetAttrib2v(const GLchar* name, const OGL_TYPE* v) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 2 ## TYPE_SUFFIX ## v (Attrib(name), v); } \
    void backlash::Program::SetAttrib3v(const GLchar* name, const OGL_TYPE* v) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 3 ## TYPE_SUFFIX ## v (Attrib(name), v); } \
    void backlash::Program::SetAttrib4v(const GLchar* name, const OGL_TYPE* v) \
        { assert(IsInUse()); glVertexAttrib ## TYPE_PREFIX ## 4 ## TYPE_SUFFIX ## v (Attrib(name), v); } \
\
    void backlash::Program::SetUniform(const GLchar* name, OGL_TYPE v0) \
        { assert(IsInUse()); glUniform1 ## TYPE_SUFFIX (Uniform(name), v0); } \
    void backlash::Program::SetUniform(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1) \
        { assert(IsInUse()); glUniform2 ## TYPE_SUFFIX (Uniform(name), v0, v1); } \
    void backlash::Program::SetUniform(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1, OGL_TYPE v2) \
        { assert(IsInUse()); glUniform3 ## TYPE_SUFFIX (Uniform(name), v0, v1, v2); } \
    void backlash::Program::SetUniform(const GLchar* name, OGL_TYPE v0, OGL_TYPE v1, OGL_TYPE v2, OGL_TYPE v3) \
        { assert(IsInUse()); glUniform4 ## TYPE_SUFFIX (Uniform(name), v0, v1, v2, v3); } \
\
    void backlash::Program::SetUniform1v(const GLchar* name, const OGL_TYPE* v, GLsizei count) \
        { assert(IsInUse()); glUniform1 ## TYPE_SUFFIX ## v (Uniform(name), count, v); } \
    void backlash::Program::SetUniform2v(const GLchar* name, const OGL_TYPE* v, GLsizei count) \
        { assert(IsInUse()); glUniform2 ## TYPE_SUFFIX ## v (Uniform(name), count, v); } \
    void backlash::Program::SetUniform3v(const GLchar* name, const OGL_TYPE* v, GLsizei count) \
        { assert(IsInUse()); glUniform3 ## TYPE_SUFFIX ## v (Uniform(name), count, v); } \
    void backlash::Program::SetUniform4v(const GLchar* name, const OGL_TYPE* v, GLsizei count) \
...
void backlash::Program::SetUniformMatrix2(const GLchar* name, const GLfloat* v, GLsizei count, GLboolean transpose) {
    assert(IsInUse());
    glUniformMatrix2fv(Uniform(name), count, transpose, v);
}

void backlash::Program::SetUniformMatrix3(const GLchar* name, const GLfloat* v, GLsizei count, GLboolean transpose) {
    assert(IsInUse());
...
void backlash::Program::SetUniform(const GLchar* name, const glm::mat2& m, GLboolean transpose) {
    assert(IsInUse());
    glUniformMatrix2fv(Uniform(name), 1, transpose, glm::value_ptr(m));
}

void backlash::Program::SetUniform(const GLchar* name, const glm::mat3& m, GLboolean transpose) {
    assert(IsInUse());
